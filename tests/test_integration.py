...
def test_full_queue_processing(tmp_path):
    ...
    total_processed = len(final_state.get("completed_referrals", [])) + len(final_state.get("escalated_referrals", []))
